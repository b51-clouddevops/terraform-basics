...
resource "aws_spot_instance_request" "cheap_worker" {
  ...
  provisioner "remote-exec" {
    inline = [
      "ansible-pull -U https://github.com/b51-clouddevops/ansible.git -e ansible_user=centos -e ansible_password=DevOps321 -e COMPONENT=${var.COMPONENT} -e APP_VERSION=0.0.2 -e ENV=dev roboshop-pull.yml"
    ]
  }
